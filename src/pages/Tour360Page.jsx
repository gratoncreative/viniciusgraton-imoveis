...
export default function Tour360Page() {
  ...
  const beneficios = [
    ...
    { t: 'Menos visita à toa', d: 'O comprador filtra sozinho o que não combina, e você ganha tempo.' },
    { t: 'Você se destaca', d: 'Pouquíssimos corretores oferecem isso, então o seu anúncio chama mais atenção.' },
  ]
      ...
      <section className="section section--light t360sec t360sec--alt">
        <div className="container">
          ...
          <div className="t360cta-final">
            ...
            <span className="t360cta-final-of">R$50 por cômodo · ou <b>grátis</b> com exclusividade de 90 dias</span>
          </div>
        </div>
      </section>
    </main>
