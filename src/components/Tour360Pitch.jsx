...
// Pitch reutilizável do diferencial Tour 360° + a oferta (R$50 por cômodo · grátis com exclusividade 90 dias).
    ...
    return (
      <Link to="/tour-360" className="t360pitch-faixa">
        ...
        <span className="t360pitch-faixa-txt">
          ...
          <span>R$50 por cômodo fotografado, ou <b>grátis</b> com exclusividade de 90 dias. Saiba mais →</span>
        </span>
      </Link>
    )
  }
  ...
  const Oferta = () => (
    <div className="t360pitch-oferta">
      <div className="t360pitch-preco">
        ...
        <span className="t360pitch-preco-lbl">por cômodo fotografado</span>
      </div>
      <div className="t360pitch-ou">ou</div>
      <div className="t360pitch-gratis">
        <span className="t360pitch-gratis-tag">GRÁTIS</span>
        <span className="t360pitch-gratis-lbl">com <b>exclusividade de 90 dias</b> comigo</span>
      </div>
    </div>
  )
  ...
  return (
    <section className="t360pitch t360pitch--bloco">
      <div className="t360pitch-bloco-in">
        ...
        <p className="t360pitch-sub">O comprador caminha pelo imóvel de casa, com mais visitas e venda mais rápida. Um diferencial que poucos oferecem.</p>
        <Oferta />
        <CTA />
      </div>
    </section>
