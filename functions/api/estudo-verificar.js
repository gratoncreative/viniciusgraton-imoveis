/**
 * Verifica no Mercado Pago se o pagamento do ESTUDO do m² foi APROVADO (servidor).
 *   GET /api/estudo-verificar?payment_id=<id>&codigo=<cod> -> { ok:true|false }
 * Só libera o download/print quando aprovado e o valor confere (R$ 4,90).
 */
